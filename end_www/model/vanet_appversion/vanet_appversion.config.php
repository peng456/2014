...
$end_models['vanet_appversion'] = array(
	...
	'list_fields' => array(
		...
		'create_time'=>array(
			'name'=>'发布时间',
			'sort'=>true,
			'filter'=>'show_vanet_appversion_date'
		),
		'_options'=>array(
			'name'=>'操作',
			'width'=>100,
			'filter'=>'show_vanet_appversion_options'
		)
	)
);


function show_vanet_appversion_date($t)
{
...
$end_rights[] = array(
	'name'=>'vanet_appversion',
	'description'=>'APP版本数据',
	'rights'=>array('view','delete','update','add')
);

function show_vanet_appversion_options($item)
{
	$id = 'appversion_id';
