...
$end_models['mechanic_document'] = array(
	...
	'list_fields' => array(
		...
		'create_time'=>array(
			...
			'width'=>110,
			'sort'=>true,
			'filter'=>'show_mechanic_document_date'
		),
		'_options'=>array(
			'name'=>'操作',
			'width'=>100,
			'filter'=>'show_mechanic_document_options'
		)
	)
);
...
function show_mechanic_document_date($t)
{
...
function show_mechanic_document_options($document)
{
