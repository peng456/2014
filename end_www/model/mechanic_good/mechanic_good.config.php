 ...
 * @author deanmongel
 */
$end_models['mechanic_good'] = array(
    'type' => 'list', //表示这是一个列表型的模型，对应一个数据库的表
    'name' => '好评表',	//某型的名字，可以把一个栏目配置成某个模型
    ...
    'fields' => array(
        ...
        'create_time' => array(
            ...
            'type' => 'text',
            'null' => true,
            'filter'=>'show_mechanic_good_date'
        )
    ),
    //显示在列表中的内容
    'list_fields' => array(
        ...
        '_options'=>array(//显示操作里面的按钮
            'name'=>'操作',
            'width'=>100,
            'filter'=>'show_mechanic_good_options'
        )
    )
);

function show_mechanic_good_date($t)
{
...
function show_mechanic_good_options($item)
{
    $id = 'good_id';
