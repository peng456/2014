...
$end_models['vanet_token'] = array(
	...
	'list_fields' => array(
		...
		'_options'=>array(
			'name'=>'操作',
			'width'=>100,
			'filter'=>'show_vanet_token_options'
		)
	)
);
/*
...
function show_vanet_token_date($t)
{
...
function show_vanet_token_options($token)
{
