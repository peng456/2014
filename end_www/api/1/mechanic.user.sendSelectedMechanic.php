...
$res = model('mechanic_driver_mechanic_question')->set(array('q_id'=>$data['q_id'],'mechanic_id'=>$data['mechanic_id'],'driver_id'=>$driver_user_id,'createtime'=>time()),array('q_id'=>$data['q_id']));
	if(!$res)
