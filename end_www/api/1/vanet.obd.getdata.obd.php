...
$total_count = get_query_item_count("SELECT count(*) from end_vanet_obds12 where nobd_id=$nobd_id");

$data = $db->get_all("SELECT * from end_vanet_obds12 where nobd_id=$nobd_id order by create_time desc limit $from, $count");
